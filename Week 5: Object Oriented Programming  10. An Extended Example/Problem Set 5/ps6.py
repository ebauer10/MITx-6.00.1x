...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowerChars = list(string.ascii_lowercase)
	      ...
	      lowerShiftVals = lowerVals[shift:] + lowerVals[:shift]

	      upperChars = list(string.ascii_uppercase)
	      upperVals = list(string.ascii_uppercase)
	      upperShiftVals = upperVals[shift:] + upperVals[:shift]
 
	      allChars = lowerChars + upperChars
	      allVals = lowerShiftVals + upperShiftVals

	    self.shift_dict = dict(zip(allChars, allVals))
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message_text:
          if char not in self.build_shift_dict(shift).keys():
            ...
            shifted_message.append(self.build_shift_dict(shift)[char])
